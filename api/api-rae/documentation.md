# ApiCol Conocimiento API Documentation
...
## Base URL
```
/api/v1/apicol conocimiento
```

## Endpoints

### GET /apicol conocimiento
Get all apicol conocimiento records
...
### GET /apicol conocimiento/{id}
Get a specific apicol conocimiento record by ID
...
### POST /apicol conocimiento
Create a new apicol conocimiento record
...
### PUT /apicol conocimiento/{id}
Update a apicol conocimiento record
...
### DELETE /apicol conocimiento/{id}
Delete a apicol conocimiento record
...
### ApiCol Conocimiento Schema
```typescript
interface ApiColConocimiento {
  id: string;
  name: string;
  description?: string;
  createdAt: Date;
...
```bash
npm install apicol conocimiento-sdk
```

## SDK Usage

```typescript
import { ApiColConocimientoAPI } from 'apicol conocimiento-sdk';

const api = new ApiColConocimientoAPI();
